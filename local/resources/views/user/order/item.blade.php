...
<label for="class_{{ $uid }}">Selegir artículo</label>
...
<div class="form-group col-md-4">
<label for="class_{{ $uid }}">Seleccionar unidad</label>
...
<label for="class_{{ $uid }}">Cantidad</label>
...
<div class="form-group col-md-4">
<label for="class_{{ $uid }}">Seleccione un artículo</label>
<select name="item_id[]" class="form-control js-select2" required="required" onchange="getUnit{{ $uid }}(this.value)">
<option value="">Seleccione</option>
@foreach($item as $i)
