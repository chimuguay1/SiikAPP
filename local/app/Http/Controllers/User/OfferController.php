...
class OfferController extends Controller {
	...
	*/
	public function store(Request $Request)
	{
		...
		return redirect(env('user').'/offer')->with('message','Nuevo registro agregado con éxito.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('user').'/offer')->with('message','Registro eliminado exitosamente.');
	}
	...
	*/
	public function status($id)
	{
		...
		return redirect(env('user').'/offer')->with('message','Estado actualizado correctamente.');
	}
}
