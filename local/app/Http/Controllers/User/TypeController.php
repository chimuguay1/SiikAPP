...
class TypeController extends Controller {
	...
	*/
	public function store(Request $Request)
	{
		...
		return redirect(env('user').'/type')->with('message','Nuevo registro agregado con éxito.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('user').'/type')->with('message','Registro eliminado exitosamente.');
	}
}
